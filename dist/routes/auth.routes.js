...
router.post('/change-password', auth_middleware_1.authenticateToken, (0, auth_middleware_1.checkRole)(['ADMIN', 'MANAGER', 'STAFF']), (0, schema_validator_middleware_1.validateSchema)(auth_validation_1.changePasswordSchema, 'body'), auth_controller_1.default.changePassword);
