...
exports.removeMediaFile = exports.jewelleryTypeImageUpload = exports.categoryMediaUpload = exports.assignmentMediaUpload = exports.communityPostMediaUpload = exports.lessonMediaUpload = exports.courseMediaUpload = exports.userProfileUpload = void 0;
...
if (!(0, fs_1.existsSync)(categoryMediaDir)) {
    (0, fs_1.mkdirSync)(categoryMediaDir, { recursive: true });
}
if (!(0, fs_1.existsSync)(jewelleryTypeMediaDir)) {
    (0, fs_1.mkdirSync)(jewelleryTypeMediaDir, { recursive: true });
}
// File name function
...
const categoryMediaStorage = multer_1.default.diskStorage({
    destination: (req, file, cb) => {
...
const jewelleryTypeMediaStorage = multer_1.default.diskStorage({
    destination: (req, file, cb) => {
...
exports.categoryMediaUpload = (0, multer_1.default)({
    storage: categoryMediaStorage,
});
exports.jewelleryTypeImageUpload = (0, multer_1.default)({
