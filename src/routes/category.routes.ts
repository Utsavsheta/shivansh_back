...
router.get('/all',  validateSchema(categoryGetAllSchema, 'query'), categoryController.getAllCategories);
router.get('/',  validateSchema(categoryGetAllPaginatedSchema, 'query'), categoryController.getAllCategoriesPaginated);
