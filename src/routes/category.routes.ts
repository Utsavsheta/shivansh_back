...
router.get('/all', authenticateToken, checkRole(['ADMIN']), validateSchema(categoryGetAllSchema, 'query'), categoryController.getAllCategories);
router.get('/', authenticateToken, checkRole(['ADMIN']), validateSchema(categoryGetAllPaginatedSchema, 'query'), categoryController.getAllCategoriesPaginated);
router.get('/:id', authenticateToken, checkRole(['ADMIN']), categoryController.getCategoryById);
